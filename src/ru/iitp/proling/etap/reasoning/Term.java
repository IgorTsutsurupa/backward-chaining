...
public class Term {
	...
	// Имя терма
	// Имя (объектной) константы - латинские буквы и цифры, начинается с буквы
	// (Bill, Mary).
	// Имя переменной - то же самое, только впереди добавляется вопросительный
	// знак (?human, ?x).
	// Литералы (числа, текстовые строки и т.д.) пока не реализованы, в
	// ближайшее время вряд ли пригодятся.
