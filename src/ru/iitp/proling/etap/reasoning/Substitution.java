...
public class Substitution
{
	...
	// Переменная может мэпится не только на другую переменную, но и на константу (?x -> Bill), но не наоборот.
	...
	// Устанавливает мэппинг для переменной, или удаляет его если задан мэппинг на саму себя
